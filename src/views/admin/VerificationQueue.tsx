        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative group">
            ...
            <Input 
              ...
              className="pl-10 bg-slate-900/50 border-slate-800 text-slate-300 w-full sm:w-64 focus:ring-blue-500/20"
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
            />
          </div>
          <Button variant="outline" className="border-slate-800 bg-slate-900/50 hover:bg-slate-800 text-slate-400 font-bold uppercase text-[10px] tracking-widest">
        ...
        <Card className="bg-slate-900/40 border-slate-800 backdrop-blur-md overflow-hidden">
          <CardHeader className="border-b border-slate-800/50 bg-slate-950/20">
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-white font-bold text-lg">Active Reports</CardTitle>
          ...
          <CardContent className="p-0">
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-[11px] font-bold text-slate-300">{report.trust_users?.institute_name}</p>
            ...
            {filteredReports.length === 0 && (
              <div className="py-32 text-center">
                ...
                <p className="text-slate-500 text-xs font-black uppercase tracking-[0.3em] mt-6">All signals validated. Network is clean.</p>
              </div>
            )}
          </CardContent>
        </Card>
