          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-card rounded-xl p-6 border border-border">
              ...
              <ul className="space-y-2">
                {data.subjectLinks.map((l, i) => (
                  <li key={i}>
                    <Link to={l.href} className="text-primary hover:underline text-sm flex items-center gap-1">
            ...
            <div className="bg-card rounded-xl p-6 border border-border">
              ...
              <div className="mt-4 pt-4 border-t border-border">
                ...
                <ul className="space-y-2">
                  <li><Link to="/home-tuition-vs-coaching-delhi" className="text-primary hover:underline text-sm flex items-center gap-1"><ArrowRight className="w-3 h-3" /> Home Tuition vs Coaching in Delhi</Link></li>
                  <li><Link to="/is-home-tuition-worth-it-delhi" className="text-primary hover:underline text-sm flex items-center gap-1"><ArrowRight className="w-3 h-3" /> Is Home Tuition Worth It?</Link></li>
                </ul>
              </div>
            </div>
          </div>
