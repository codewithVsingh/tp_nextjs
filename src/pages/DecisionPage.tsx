            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-2">
                  {topSubjects.map(s => (
                    <li key={s.slug}>
                      <Link to={`/tutors/${s.slug}-delhi`} className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {topAreas.map(a => (
                    <li key={a.slug}>
                      <Link to={`/home-tuition-in-${a.slug}`} className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors">
