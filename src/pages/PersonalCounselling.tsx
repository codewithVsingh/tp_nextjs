        ...
        <section className="py-12 bg-muted/40">
          <div className="container max-w-4xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <Link to="/counselling/student" className="px-5 py-2.5 rounded-full border border-border bg-card hover:border-primary text-sm font-medium transition-colors">Student Counselling</Link>
